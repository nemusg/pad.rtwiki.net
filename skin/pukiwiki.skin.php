...
<ul>
	<li class="setskin"><a href="setskin.php">スマホ版</a></li>
...
<div class="twoColumn cfx">
  ...
  <div id="menubar">
    <section>
		...
		<?php include("htmlinsert/ad.inc"); ?>
		<?php if (exist_plugin_convert('menu2')) { ?><?php echo do_plugin_convert('menu2') ?><?php } ?>
	</section>
  </div>
</div>
<?php } else { ?>
...
<?php if ($is_page) { ?>
<?php if ($rw) { ?>
	<!--<li><?php _toolbar('edit') ?></li>-->
	<?php if ($is_read && $function_freeze) { ?>
		<!--<li><?php if (! $is_freeze) { _toolbar('freeze'); } else { _toolbar('unfreeze'); } ?></li>-->
	<?php } ?>
<?php } ?>
...
<?php } ?>
	...
	<li><a href="<?php echo $link['rss10'] ?>">RSS</a></li>
</ul>
<ul>
...
<div id="footer">
<div class="dvCopy">
	<p>Puzzle and Dragons Wiki admin: <a href="https://twitter.com/rtwiki_net">@rtwiki_net</a> <a href="http://nemusg.com/contact.html">問い合わせ</a><br>
	<?php echo S_COPYRIGHT ?>.
	Powered by PHP <?php echo PHP_VERSION ?>.
	HTML convert time: <?php echo $taketime ?> sec.<br>
	<?php echo bodycache_signature_gen() ?></p>
</div>
	<?php if (arg_check('read') && exist_plugin_convert('menu')) { ?>
	<?php include("htmlinsert/ad728x90.inc"); ?>
	<?php } ?>
</div>
